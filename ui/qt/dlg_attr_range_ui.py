...
#
# Created: Thu Feb 14 14:59:20 2013
...
class Ui_attrRangesDialog(object):
    def setupUi(self, attrRangesDialog):
        ...
        attrRangesDialog.resize(281, 308)
        self.buttons = QtGui.QDialogButtonBox(attrRangesDialog)
        self.buttons.setGeometry(QtCore.QRect(90, 270, 171, 32))
        ...
        self.btn_add.setGeometry(QtCore.QRect(200, 50, 31, 23))
        ...
        self.table_ranges.setGeometry(QtCore.QRect(20, 80, 241, 191))
        ...
        self.btn_delete.setGeometry(QtCore.QRect(230, 50, 31, 23))
