...
class Ui_tablePreviewDialog(object):
    def setupUi(self, tablePreviewDialog):
        ...
        self.lb_bldgcount.setGeometry(QtCore.QRect(10, 320, 111, 25))
        ...
        self.txt_bldgcount.setGeometry(QtCore.QRect(130, 320, 81, 20))
    ...
    def retranslateUi(self, tablePreviewDialog):
        tablePreviewDialog.setWindowTitle(QtGui.QApplication.translate("tablePreviewDialog", "Feature Information", None, QtGui.QApplication.UnicodeUTF8))
        self.lb_title.setText(QtGui.QApplication.translate("tablePreviewDialog", "Detailed Information for Selected Feature", None, QtGui.QApplication.UnicodeUTF8))
        self.lb_bldgcount.setText(QtGui.QApplication.translate("tablePreviewDialog", "Building Count", None, QtGui.QApplication.UnicodeUTF8))
