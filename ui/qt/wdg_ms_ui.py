...
#
# Created: Tue Feb 05 16:39:19 2013
...
class Ui_widgetMappingSchemes(object):
    def setupUi(self, widgetMappingSchemes):
        ...
        self.btn_edit_level.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/add.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_add_child.setIcon(icon3)
        ...
        self.btn_expand_tree.setIcon(icon4)
        ...
        self.btn_collapse_tree.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_save_ms.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_create_ms.setIcon(icon7)
