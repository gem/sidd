...
class Ui_widgetMappingSchemes(object):
    def setupUi(self, widgetMappingSchemes):
        ...
        self.widget_ms_buttons_r.setGeometry(QtCore.QRect(210, 0, 121, 31))
        ...
        self.btn_edit_level.setGeometry(QtCore.QRect(90, 0, 31, 23))
        ...
        self.btn_del_child.setGeometry(QtCore.QRect(60, 0, 31, 23))
        ...
        self.btn_add_child.setGeometry(QtCore.QRect(30, 0, 31, 23))
        ...
        self.btn_add_zone.setGeometry(QtCore.QRect(0, 0, 31, 23))
        ...
        self.widget_ms_buttons_l.setGeometry(QtCore.QRect(0, 0, 191, 31))
        ...
        self.btn_save_ms.setGeometry(QtCore.QRect(60, 0, 31, 23))
        ...
        self.btn_expand_tree.setGeometry(QtCore.QRect(130, 0, 31, 23))
        ...
        self.btn_collapse_tree.setGeometry(QtCore.QRect(160, 0, 31, 23))
        ...
        self.btn_save_to_lib = QtGui.QPushButton(self.widget_ms_buttons_l)
        self.btn_save_to_lib.setGeometry(QtCore.QRect(90, 0, 31, 23))
        self.btn_save_to_lib.setText(_fromUtf8(""))
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/book.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_save_to_lib.setIcon(icon8)
        self.btn_save_to_lib.setObjectName(_fromUtf8("btn_save_to_lib"))
        self.btn_load_ms = QtGui.QPushButton(self.widget_ms_buttons_l)
        self.btn_load_ms.setGeometry(QtCore.QRect(30, 0, 31, 23))
        self.btn_load_ms.setText(_fromUtf8(""))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/folder_open.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_load_ms.setIcon(icon9)
        self.btn_load_ms.setObjectName(_fromUtf8("btn_load_ms"))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/arrow_left.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_add_branch.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/minus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_del_lib_ms.setIcon(icon11)
    ...
    def retranslateUi(self, widgetMappingSchemes):
        ...
        self.btn_save_to_lib.setToolTip(QtGui.QApplication.translate("widgetMappingSchemes", "Save Mapping Scheme into Library", None, QtGui.QApplication.UnicodeUTF8))
        self.btn_load_ms.setToolTip(QtGui.QApplication.translate("widgetMappingSchemes", "Load Mapping Scheme XML", None, QtGui.QApplication.UnicodeUTF8))
