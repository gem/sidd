...
#
# Created: Fri Apr 26 13:40:45 2013
...
class Ui_widgetMappingSchemes(object):
    def setupUi(self, widgetMappingSchemes):
        ...
        self.btn_refresh_tree = QtGui.QPushButton(self.widget_ms_tree)
        self.btn_refresh_tree.setGeometry(QtCore.QRect(100, 0, 31, 23))
        self.btn_refresh_tree.setText(_fromUtf8(""))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/refresh.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_refresh_tree.setIcon(icon6)
        self.btn_refresh_tree.setObjectName(_fromUtf8("btn_refresh_tree"))
        self.btn_collapse_tree = QtGui.QPushButton(self.widget_ms_tree)
        ...
        self.btn_expand_tree = QtGui.QPushButton(self.widget_ms_tree)
        self.btn_expand_tree.setGeometry(QtCore.QRect(130, 0, 31, 23))
        self.btn_expand_tree.setText(_fromUtf8(""))
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/magnify_plus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_expand_tree.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/arrow_left.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_add_branch.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/imgs/icons/minus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_del_lib_ms.setIcon(icon10)
    ...
    def retranslateUi(self, widgetMappingSchemes):
        ...
        self.btn_refresh_tree.setToolTip(QtGui.QApplication.translate("widgetMappingSchemes", "Expand Mapping Scheme Tree", None, QtGui.QApplication.UnicodeUTF8))
