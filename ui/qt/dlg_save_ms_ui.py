...
class Ui_saveMSDialog(object):
    def setupUi(self, saveMSDialog):
        ...
        self.lb_ms_region.setGeometry(QtCore.QRect(10, 50, 80, 20))
        ...
        self.lb_ms_create_date.setGeometry(QtCore.QRect(10, 140, 80, 20))
    ...
    def retranslateUi(self, saveMSDialog):
        saveMSDialog.setWindowTitle(QtGui.QApplication.translate("saveMSDialog", "Save Mapping Scheme", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lb_ms_quality.setText(QtGui.QApplication.translate("saveMSDialog", "Data Measured", None, QtGui.QApplication.UnicodeUTF8))
